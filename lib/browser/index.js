    ...
    constructor(config = defaultConfig) {
        ...
        this.meta = {
            ...
            get base() {
                ...
                return corrosion.window.document.baseURI != corrosion.window.location.href ? new URL(corrosion.url.unwrap(corrosion.window.location.href, { origin: corrosion.window.location.origin, })) : corrosion._url;
            },
            url: this._url,
        };
